    ...
    <div class="container-fluid" style="color: #9acfea">
        <div class="navbar-header">
            <div class="navbar-brand">
                <a href="/admin/tutors"><span class="glyphicon glyphicon-circle-arrow-left"></span></a>
            </div>
...
<div class="container">
    <div class="key-form">
        <h3>Добавление тьютора</h3>

        <form method="post" action="/admin/tutors/add" class="">
            <div class="row">
                <div class="col-md-8">
                    <div class="form-group">
                        <input class="form-control" name="name" id="name" placeholder="Имя" type="text" required>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="form-group">
                        <input class="form-control" name="contacts" id="contacts" placeholder="Контакты" type="text" required>
                    </div>
                </div>
            </div>
